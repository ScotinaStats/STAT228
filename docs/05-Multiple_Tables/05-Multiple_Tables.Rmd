...
This is not the same as the number of rows in the original `flights` table! This means that there were *some* destination airports in `flights` that didn't actually appear in `airports`
