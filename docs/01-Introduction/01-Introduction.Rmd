...
- Student Hours (~in my office~ on Zoom):
    - Thursday, 2pm-3pm; Friday 11am-1pm (all times EST)
...
- Read the **syllabus**, and let me know if you have any questions or concerns. 

- Join our **Slack** workspace if you haven't yet. 

- Install R and R Studio, verify that **R Studio** opens. 
...
If you're finding yourself stuck on a particular exercise and not understanding, take a break, talk to classmates, e-mail me, stop by my office, etc.
...
- Create a new folder called `MATH228_Notes`. 
